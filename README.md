# Fixes
### → Fixed a couple css bugs where on hover the item would go black but the item title text stayed black, added classes to fix this bug in media, and in glossary was just case of adding the color change to the whole item hover (initially had it with just the term hover but when hovering over the def it would change back to black) 
### → Added first term into gloss
### → Added custom cursor for vibes lol
# Plan
